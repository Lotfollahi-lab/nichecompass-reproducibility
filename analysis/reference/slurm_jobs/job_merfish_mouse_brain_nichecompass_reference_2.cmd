#!/bin/bash
#SBATCH -J merfish_mouse_brain_nichecompass_reference_2
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_merfish_mouse_brain_nichecompass_reference_2.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_merfish_mouse_brain_nichecompass_reference_2.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
