#!/bin/bash
#SBATCH -J seqfish_mouse_organogenesis_imputed_subsample_10pct_nichecompass_one-hop-norm_reference_query_query_mapping_14
#SBATCH -o ./data_analysis/reference_query/slurm_jobs/logs/out_seqfish_mouse_organogenesis_imputed_subsample_10pct_nichecompass_one-hop-norm_reference_query_query_mapping_14.txt
#SBATCH -e ./data_analysis/reference_query/slurm_jobs/logs/err_seqfish_mouse_organogenesis_imputed_subsample_10pct_nichecompass_one-hop-norm_reference_query_query_mapping_14.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
