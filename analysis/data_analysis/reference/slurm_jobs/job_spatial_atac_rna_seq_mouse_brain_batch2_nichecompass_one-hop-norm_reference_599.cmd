#!/bin/bash
#SBATCH -J spatial_atac_rna_seq_mouse_brain_batch2_nichecompass_one-hop-norm_reference_599
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_spatial_atac_rna_seq_mouse_brain_batch2_nichecompass_one-hop-norm_reference_599.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_spatial_atac_rna_seq_mouse_brain_batch2_nichecompass_one-hop-norm_reference_599.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
