...
trained_model_umaps_directory = "trained_model_umaps:mebocost"
...
os.makedirs("enriched-gps:mebocost", exist_ok=True)

file_name = f"enriched_gps.pkl"
local_file = os.path.join("enriched-gps:mebocost", file_name)
