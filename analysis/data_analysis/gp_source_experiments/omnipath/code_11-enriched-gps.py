...
trained_model_umaps_directory = "trained_model_umaps:omnipath"
...
os.makedirs("enriched-gps:omnipath", exist_ok=True)

file_name = f"enriched_gps.pkl"
local_file = os.path.join("enriched-gps:omnipath", file_name)
