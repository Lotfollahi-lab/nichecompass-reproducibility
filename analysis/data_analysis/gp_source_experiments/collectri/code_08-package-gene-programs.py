...
gene_programs_directory = "processed-gene-programs:collectri"
...
os.makedirs("dataset-with-gene-programs:collectri", exist_ok=True)
file_name = "dataset_with_gene_programs.h5ad"
local_file = os.path.join("dataset-with-gene-programs:collectri", file_name)
