...
trained_model_artifact_directory = "trained-model:collectri"
trained_model_umaps_directory = "trained_model_umaps:collectri"
...
os.makedirs("enriched-gps:collectri", exist_ok=True)

file_name = f"enriched_gps.pkl"
local_file = os.path.join("enriched-gps:collectri", file_name)
