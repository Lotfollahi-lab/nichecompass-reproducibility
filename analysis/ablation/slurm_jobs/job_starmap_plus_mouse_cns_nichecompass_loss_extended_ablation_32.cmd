#!/bin/bash
#SBATCH -J starmap_plus_mouse_cns_nichecompass_loss_extended_ablation_32
#SBATCH -o ./ablation/slurm_jobs/logs/out_starmap_plus_mouse_cns_nichecompass_loss_extended_ablation_32.txt
#SBATCH -e ./ablation/slurm_jobs/logs/err_starmap_plus_mouse_cns_nichecompass_loss_extended_ablation_32.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
