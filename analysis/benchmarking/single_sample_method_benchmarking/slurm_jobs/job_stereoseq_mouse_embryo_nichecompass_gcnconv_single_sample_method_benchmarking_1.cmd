#!/bin/bash
#SBATCH -J stereoseq_mouse_embryo_nichecompass_gcnconv_single_sample_method_benchmarking_1
#SBATCH -o ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/out_stereoseq_mouse_embryo_nichecompass_gcnconv_single_sample_method_benchmarking_1.txt
#SBATCH -e ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/err_stereoseq_mouse_embryo_nichecompass_gcnconv_single_sample_method_benchmarking_1.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
