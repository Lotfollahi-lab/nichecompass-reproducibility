#!/bin/bash
#SBATCH -J sim1_1105genes_10000locs_strongincrements_nichecompass_gatv2conv_single_sample_method_benchmarking_31
#SBATCH -o ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/out_sim1_1105genes_10000locs_strongincrements_nichecompass_gatv2conv_single_sample_method_benchmarking_31.txt
#SBATCH -e ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/err_sim1_1105genes_10000locs_strongincrements_nichecompass_gatv2conv_single_sample_method_benchmarking_31.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
