#!/bin/bash
#SBATCH -J banksy_single_sample_method_benchmarking_stereoseq_mouse_embryo_metrics_computation_1
#SBATCH -o ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/out_banksy_single_sample_method_benchmarking_stereoseq_mouse_embryo_metrics_computation_1.txt
#SBATCH -e ./benchmarking/single_sample_method_benchmarking/slurm_jobs/logs/err_banksy_single_sample_method_benchmarking_stereoseq_mouse_embryo_metrics_computation_1.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
