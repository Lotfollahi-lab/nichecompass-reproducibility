#!/bin/bash
#SBATCH -J nanostring_cosmx_human_nsclc_subsample_5pct_nichecompass_gatv2conv_sample_integration_method_benchmarking_1
#SBATCH -o ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/out_nanostring_cosmx_human_nsclc_subsample_5pct_nichecompass_gatv2conv_sample_integration_method_benchmarking_1.txt
#SBATCH -e ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/err_nanostring_cosmx_human_nsclc_subsample_5pct_nichecompass_gatv2conv_sample_integration_method_benchmarking_1.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
