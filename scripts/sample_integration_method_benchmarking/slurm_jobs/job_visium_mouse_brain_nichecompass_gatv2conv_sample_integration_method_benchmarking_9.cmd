#!/bin/bash
#SBATCH -J visium_mouse_brain_nichecompass_gatv2conv_sample_integration_method_benchmarking_9
#SBATCH -o ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/out_visium_mouse_brain_nichecompass_gatv2conv_sample_integration_method_benchmarking_9.txt
#SBATCH -e ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/err_visium_mouse_brain_nichecompass_gatv2conv_sample_integration_method_benchmarking_9.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
