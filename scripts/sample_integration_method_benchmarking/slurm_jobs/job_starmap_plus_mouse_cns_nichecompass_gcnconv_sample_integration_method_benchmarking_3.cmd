#!/bin/bash
#SBATCH -J starmap_plus_mouse_cns_nichecompass_gcnconv_sample_integration_method_benchmarking_3
#SBATCH -o ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/out_starmap_plus_mouse_cns_nichecompass_gcnconv_sample_integration_method_benchmarking_3.txt
#SBATCH -e ../scripts/sample_integration_method_benchmarking/slurm_jobs/logs/err_starmap_plus_mouse_cns_nichecompass_gcnconv_sample_integration_method_benchmarking_3.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
