...
do
    ...
    --model_label one-hop-attention_no_cond_cont_sample_integration_method_benchmarking \
...
do
    ...
    --gp_sources_mask_key nichecompass_gp_sources \
    --gp_names_key nichecompass_gp_names \
    --model_label one-hop-attention_low_cond_cont_sample_integration_method_benchmarking \
    --active_gp_names_key nichecompass_active_gp_names \
    --latent_key nichecompass_latent \
    --active_gp_thresh_ratio 0.1 \
    --gene_expr_recon_dist nb \
...
do
    ...
    --gp_sources_mask_key nichecompass_gp_sources \
    --gp_names_key nichecompass_gp_names \
    --model_label one-hop-attention_high_cond_cont_sample_integration_method_benchmarking \
    --active_gp_names_key nichecompass_active_gp_names \
    --latent_key nichecompass_latent \
    --active_gp_thresh_ratio 0.1 \
    --gene_expr_recon_dist nb \
