#!/bin/bash
#SBATCH -J seqfish_mouse_organogenesis_embryo2_nichecompass_gatv2conv_single_sample_method_benchmarking_1
#SBATCH -o ../scripts/single_sample_method_benchmarking/slurm_jobs/logs/out_seqfish_mouse_organogenesis_embryo2_nichecompass_gatv2conv_single_sample_method_benchmarking_1.txt
#SBATCH -e ../scripts/single_sample_method_benchmarking/slurm_jobs/logs/err_seqfish_mouse_organogenesis_embryo2_nichecompass_gatv2conv_single_sample_method_benchmarking_1.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
