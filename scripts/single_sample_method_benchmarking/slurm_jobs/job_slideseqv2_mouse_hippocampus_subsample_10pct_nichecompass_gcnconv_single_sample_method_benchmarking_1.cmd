#!/bin/bash
#SBATCH -J slideseqv2_mouse_hippocampus_subsample_10pct_nichecompass_gcnconv_single_sample_method_benchmarking_1
#SBATCH -o ../scripts/single_sample_method_benchmarking/slurm_jobs/logs/out_slideseqv2_mouse_hippocampus_subsample_10pct_nichecompass_gcnconv_single_sample_method_benchmarking_1.txt
#SBATCH -e ../scripts/single_sample_method_benchmarking/slurm_jobs/logs/err_slideseqv2_mouse_hippocampus_subsample_10pct_nichecompass_gcnconv_single_sample_method_benchmarking_1.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
