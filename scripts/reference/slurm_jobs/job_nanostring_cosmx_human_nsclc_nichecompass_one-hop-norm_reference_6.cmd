#!/bin/bash
#SBATCH -J nanostring_cosmx_human_nsclc_nichecompass_one-hop-norm_reference_6
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_nanostring_cosmx_human_nsclc_nichecompass_one-hop-norm_reference_6.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_nanostring_cosmx_human_nsclc_nichecompass_one-hop-norm_reference_6.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
