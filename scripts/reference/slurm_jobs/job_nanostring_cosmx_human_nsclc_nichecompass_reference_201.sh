#!/bin/bash
#SBATCH -J 201_nanostring_cosmx_human_nsclc_nichecompass_reference
#SBATCH -o logs/out_nanostring_cosmx_human_nsclc_nichecompass_reference_201.txt
#SBATCH -e logs/err_nanostring_cosmx_human_nsclc_nichecompass_reference_201.txt
#SBATCH -t 24:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
