#!/bin/bash
#SBATCH -J starmap_plus_mouse_cns_nichecompass_one-hop-norm_reference_5
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_starmap_plus_mouse_cns_nichecompass_one-hop-norm_reference_5.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_starmap_plus_mouse_cns_nichecompass_one-hop-norm_reference_5.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
