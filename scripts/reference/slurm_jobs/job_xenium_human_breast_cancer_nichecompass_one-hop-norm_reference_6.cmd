#!/bin/bash
#SBATCH -J xenium_human_breast_cancer_nichecompass_one-hop-norm_reference_6
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_xenium_human_breast_cancer_nichecompass_one-hop-norm_reference_6.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_xenium_human_breast_cancer_nichecompass_one-hop-norm_reference_6.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
