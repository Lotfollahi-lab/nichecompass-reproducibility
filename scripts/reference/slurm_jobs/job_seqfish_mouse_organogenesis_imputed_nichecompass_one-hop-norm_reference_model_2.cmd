#!/bin/bash
#SBATCH -J seqfish_mouse_organogenesis_imputed_nichecompass_one-hop-norm_reference_model_2
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_seqfish_mouse_organogenesis_imputed_nichecompass_one-hop-norm_reference_model_2.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_seqfish_mouse_organogenesis_imputed_nichecompass_one-hop-norm_reference_model_2.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
