#!/bin/bash
#SBATCH -J vizgen_merfish_human_ovarian_cancer_nichecompass_one-hop-attention_reference_model_2
#SBATCH -o ../scripts/reference/slurm_jobs/logs/out_vizgen_merfish_human_ovarian_cancer_nichecompass_one-hop-attention_reference_model_2.txt
#SBATCH -e ../scripts/reference/slurm_jobs/logs/err_vizgen_merfish_human_ovarian_cancer_nichecompass_one-hop-attention_reference_model_2.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
