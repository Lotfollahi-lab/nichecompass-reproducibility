#!/bin/bash
#SBATCH -J seqfish_mouse_organogenesis_nichecompass_one-hop-norm_ablation_3
#SBATCH -o ../scripts/ablation/slurm_jobs/logs/out_seqfish_mouse_organogenesis_nichecompass_one-hop-norm_ablation_3.txt
#SBATCH -e ../scripts/ablation/slurm_jobs/logs/err_seqfish_mouse_organogenesis_nichecompass_one-hop-norm_ablation_3.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
