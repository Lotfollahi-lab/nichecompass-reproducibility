#!/bin/bash
#SBATCH -J xenium_human_breast_cancer_nichecompass_encoder_architecture_ablation_22
#SBATCH -o ../scripts/ablation/slurm_jobs/logs/out_xenium_human_breast_cancer_nichecompass_encoder_architecture_ablation_22.txt
#SBATCH -e ../scripts/ablation/slurm_jobs/logs/err_xenium_human_breast_cancer_nichecompass_encoder_architecture_ablation_22.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
