#!/bin/bash
#SBATCH -J nichecompass_encoder_architecture_ablation_xenium_human_breast_cancer_metrics_computation_5
#SBATCH -o ../scripts/ablation/slurm_jobs/logs/out_nichecompass_encoder_architecture_ablation_xenium_human_breast_cancer_metrics_computation_5.txt
#SBATCH -e ../scripts/ablation/slurm_jobs/logs/err_nichecompass_encoder_architecture_ablation_xenium_human_breast_cancer_metrics_computation_5.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
