...
python ../compute_metrics.py --task loss_weights_ablation --file_name mlflow_summary_loss_weights_ablation_100.csv --datasets xenium_human_breast_cancer --cell_type_keys cell_states --batch_keys None
