#!/bin/bash
#SBATCH -J starmap_plus_mouse_cns_nichecompass_encoder_architecture_ablation_29
#SBATCH -o ../scripts/ablation/slurm_jobs/logs/out_starmap_plus_mouse_cns_nichecompass_encoder_architecture_ablation_29.txt
#SBATCH -e ../scripts/ablation/slurm_jobs/logs/err_starmap_plus_mouse_cns_nichecompass_encoder_architecture_ablation_29.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
