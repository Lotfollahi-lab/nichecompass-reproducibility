#!/bin/bash
#SBATCH -J vizgen_merfish_human_ovarian_cancer_nichecompass_loss_weights_ablation_46
#SBATCH -o ../scripts/ablation/slurm_jobs/logs/out_vizgen_merfish_human_ovarian_cancer_nichecompass_loss_weights_ablation_46.txt
#SBATCH -e ../scripts/ablation/slurm_jobs/logs/err_vizgen_merfish_human_ovarian_cancer_nichecompass_loss_weights_ablation_46.txt
#SBATCH -t 48:00:00
#SBATCH -p gpu_p
#SBATCH -c 6
#SBATCH --gres=gpu:1
